...
DOWNLOAD_LINK="https://github.com/protocolbuffers/protobuf.git"
# https://github.com/protocolbuffers/protobuf/archive/v3.14.0.tar.gz
#git clone --branch v3.14.0  https://github.com/protocolbuffers/protobuf.git


sudo apt-get install autoconf automake libtool curl make g++ unzip 
sudo git clone https://github.com/protocolbuffers/protobuf.git
#sudo git clone --branch v3.20.1  https://github.com/protocolbuffers/protobuf.git
chmod 777 protobuf

pushd protobuf
  git submodule update --init --recursive
  ./autogen.sh
#  ./configure --prefix=/usr/local/lib/protobuf_${VERSION}
  ./configure 
   make
   make check 
   sudo make install
