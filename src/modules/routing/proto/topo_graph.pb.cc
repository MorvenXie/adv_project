...
CurvePoint::CurvePoint(const CurvePoint& from)
  ...
  CurvePoint* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void CurvePoint::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CurvePoint*>(&to_msg);
  auto& from = static_cast<const CurvePoint&>(from_msg);
...
CurveRange::CurveRange(const CurveRange& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  CurveRange* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.start_){nullptr}
  ...
  if (from._internal_has_start()) {
    _this->_impl_.start_ = new ::apollo::routing::CurvePoint(*from._impl_.start_);
  }
  if (from._internal_has_end()) {
    _this->_impl_.end_ = new ::apollo::routing::CurvePoint(*from._impl_.end_);
  }
...
void CurveRange::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CurveRange*>(&to_msg);
  auto& from = static_cast<const CurveRange&>(from_msg);
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_start()->::apollo::routing::CurvePoint::MergeFrom(
          from._internal_start());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_end()->::apollo::routing::CurvePoint::MergeFrom(
          from._internal_end());
    }
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
Node::Node(const Node& from)
  ...
  if (from._internal_has_road_id()) {
    _this->_impl_.road_id_.Set(from._internal_road_id(), 
      _this->GetArenaForAllocation());
  }
...
void Node::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.left_out_.MergeFrom(from._impl_.left_out_);
  _this->_impl_.right_out_.MergeFrom(from._impl_.right_out_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x0000003fu) {
    if (cached_has_bits & 0x00000001u) {
...
Edge::Edge(const Edge& from)
  ...
  if (from._internal_has_from_lane_id()) {
    _this->_impl_.from_lane_id_.Set(from._internal_from_lane_id(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_to_lane_id()) {
    _this->_impl_.to_lane_id_.Set(from._internal_to_lane_id(), 
      _this->GetArenaForAllocation());
  }
...
void Edge::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_from_lane_id(from._internal_from_lane_id());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_to_lane_id(from._internal_to_lane_id());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.cost_ = from._impl_.cost_;
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.direction_type_ = from._impl_.direction_type_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
Graph::Graph(const Graph& from)
  ...
  if (from._internal_has_hdmap_version()) {
    _this->_impl_.hdmap_version_.Set(from._internal_hdmap_version(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_hdmap_district()) {
    _this->_impl_.hdmap_district_.Set(from._internal_hdmap_district(), 
      _this->GetArenaForAllocation());
  }
...
void Graph::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_hdmap_version(from._internal_hdmap_version());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_hdmap_district(from._internal_hdmap_district());
    }
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
