...
TopicConfig::TopicConfig(const TopicConfig& from)
  ...
  TopicConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_routing_response_topic()) {
    _this->_impl_.routing_response_topic_.Set(from._internal_routing_response_topic(), 
  ...
  if (from._internal_has_routing_response_history_topic()) {
    _this->_impl_.routing_response_history_topic_.Set(from._internal_routing_response_history_topic(), 
      _this->GetArenaForAllocation());
  }
...
void TopicConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_routing_response_topic(from._internal_routing_response_topic());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_routing_response_history_topic(from._internal_routing_response_history_topic());
    }
  }
...
RoutingConfig::RoutingConfig(const RoutingConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RoutingConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.topic_config_){nullptr}
  ...
  if (from._internal_has_topic_config()) {
    _this->_impl_.topic_config_ = new ::apollo::routing::TopicConfig(*from._impl_.topic_config_);
  }
...
void RoutingConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RoutingConfig*>(&to_msg);
  auto& from = static_cast<const RoutingConfig&>(from_msg);
  ...
  if (cached_has_bits & 0x0000007fu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_topic_config()->::apollo::routing::TopicConfig::MergeFrom(
          from._internal_topic_config());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.base_speed_ = from._impl_.base_speed_;
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.left_turn_penalty_ = from._impl_.left_turn_penalty_;
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.right_turn_penalty_ = from._impl_.right_turn_penalty_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.uturn_penalty_ = from._impl_.uturn_penalty_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.change_penalty_ = from._impl_.change_penalty_;
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.base_changing_length_ = from._impl_.base_changing_length_;
    }
