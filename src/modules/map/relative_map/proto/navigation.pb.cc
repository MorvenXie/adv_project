...
NavigationPath::NavigationPath(const NavigationPath& from)
  ...
  if (from._internal_has_path()) {
    _this->_impl_.path_ = new ::apollo::common::Path(*from._impl_.path_);
  }
  _this->_impl_.path_priority_ = from._impl_.path_priority_;
...
void NavigationPath::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_path()->::apollo::common::Path::MergeFrom(
          from._internal_path());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.path_priority_ = from._impl_.path_priority_;
...
NavigationInfo::NavigationInfo(const NavigationInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  NavigationInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void NavigationInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<NavigationInfo*>(&to_msg);
  auto& from = static_cast<const NavigationInfo&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:apollo.relative_map.NavigationInfo)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.navigation_path_.MergeFrom(from._impl_.navigation_path_);
  if (from._internal_has_header()) {
...
MapMsg::MapMsg(const MapMsg& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MapMsg* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , /*decltype(_impl_.navigation_path_)*/{}
  ...
  if (from._internal_has_hdmap()) {
    _this->_impl_.hdmap_ = new ::apollo::hdmap::Map(*from._impl_.hdmap_);
  }
  ...
  if (from._internal_has_localization()) {
    _this->_impl_.localization_ = new ::apollo::localization::LocalizationEstimate(*from._impl_.localization_);
  }
...
void MapMsg::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MapMsg*>(&to_msg);
  auto& from = static_cast<const MapMsg&>(from_msg);
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_hdmap()->::apollo::hdmap::Map::MergeFrom(
          from._internal_hdmap());
    }
    if (cached_has_bits & 0x00000004u) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_mutable_localization()->::apollo::localization::LocalizationEstimate::MergeFrom(
