...
MapGenerationParam::MapGenerationParam(const MapGenerationParam& from)
  ...
  MapGenerationParam* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void MapGenerationParam::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MapGenerationParam*>(&to_msg);
  auto& from = static_cast<const MapGenerationParam&>(from_msg);
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_impl_.default_left_width_ = from._impl_.default_left_width_;
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.default_right_width_ = from._impl_.default_right_width_;
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.default_speed_limit_ = from._impl_.default_speed_limit_;
    }
...
NavigationLaneConfig::NavigationLaneConfig(const NavigationLaneConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  NavigationLaneConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void NavigationLaneConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<NavigationLaneConfig*>(&to_msg);
  auto& from = static_cast<const NavigationLaneConfig&>(from_msg);
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_impl_.lane_source_ = from._impl_.lane_source_;
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.min_lane_marker_quality_ = from._impl_.min_lane_marker_quality_;
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.max_len_from_navigation_line_ = from._impl_.max_len_from_navigation_line_;
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.min_len_for_navigation_lane_ = from._impl_.min_len_for_navigation_lane_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.max_len_for_navigation_lane_ = from._impl_.max_len_for_navigation_lane_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.ratio_navigation_lane_len_to_speed_ = from._impl_.ratio_navigation_lane_len_to_speed_;
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.max_distance_to_navigation_line_ = from._impl_.max_distance_to_navigation_line_;
    }
    if (cached_has_bits & 0x00000080u) {
      _this->_impl_.min_view_range_to_use_lane_marker_ = from._impl_.min_view_range_to_use_lane_marker_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00000700u) {
    if (cached_has_bits & 0x00000100u) {
      _this->_impl_.min_lane_half_width_ = from._impl_.min_lane_half_width_;
    }
    if (cached_has_bits & 0x00000200u) {
      _this->_impl_.max_lane_half_width_ = from._impl_.max_lane_half_width_;
    }
    if (cached_has_bits & 0x00000400u) {
      _this->_impl_.lane_marker_weight_ = from._impl_.lane_marker_weight_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
RelativeMapConfig::RelativeMapConfig(const RelativeMapConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RelativeMapConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.map_param_){nullptr}
  ...
  if (from._internal_has_map_param()) {
    _this->_impl_.map_param_ = new ::apollo::relative_map::MapGenerationParam(*from._impl_.map_param_);
  }
  if (from._internal_has_navigation_lane()) {
    _this->_impl_.navigation_lane_ = new ::apollo::relative_map::NavigationLaneConfig(*from._impl_.navigation_lane_);
  }
...
void RelativeMapConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RelativeMapConfig*>(&to_msg);
  auto& from = static_cast<const RelativeMapConfig&>(from_msg);
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_map_param()->::apollo::relative_map::MapGenerationParam::MergeFrom(
          from._internal_map_param());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_navigation_lane()->::apollo::relative_map::NavigationLaneConfig::MergeFrom(
          from._internal_navigation_lane());
    }
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
