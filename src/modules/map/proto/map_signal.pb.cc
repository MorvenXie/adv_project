...
Subsignal::Subsignal(const Subsignal& from)
  ...
  Subsignal* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_location()) {
    _this->_impl_.location_ = new ::apollo::common::PointENU(*from._impl_.location_);
  }
...
void Subsignal::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<Subsignal*>(&to_msg);
  auto& from = static_cast<const Subsignal&>(from_msg);
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_location()->::apollo::common::PointENU::MergeFrom(
...
SignInfo::SignInfo(const SignInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  SignInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.type_){}};
...
void SignInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<SignInfo*>(&to_msg);
  auto& from = static_cast<const SignInfo&>(from_msg);
...
Signal::Signal(const Signal& from)
  ...
  if (from._internal_has_boundary()) {
    _this->_impl_.boundary_ = new ::apollo::hdmap::Polygon(*from._impl_.boundary_);
  }
  _this->_impl_.type_ = from._impl_.type_;
...
void Signal::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_boundary()->::apollo::hdmap::Polygon::MergeFrom(
