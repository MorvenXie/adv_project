...
ClearArea::ClearArea(const ClearArea& from)
  ...
  ClearArea* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void ClearArea::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ClearArea*>(&to_msg);
  auto& from = static_cast<const ClearArea&>(from_msg);
