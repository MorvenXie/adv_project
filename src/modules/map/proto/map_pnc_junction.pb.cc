...
void Passage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.signal_id_.MergeFrom(from._impl_.signal_id_);
  _this->_impl_.yield_id_.MergeFrom(from._impl_.yield_id_);
  _this->_impl_.stop_sign_id_.MergeFrom(from._impl_.stop_sign_id_);
...
PassageGroup::PassageGroup(const PassageGroup& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  PassageGroup* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void PassageGroup::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<PassageGroup*>(&to_msg);
  auto& from = static_cast<const PassageGroup&>(from_msg);
...
PNCJunction::PNCJunction(const PNCJunction& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  PNCJunction* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_polygon()) {
    _this->_impl_.polygon_ = new ::apollo::hdmap::Polygon(*from._impl_.polygon_);
  }
...
void PNCJunction::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<PNCJunction*>(&to_msg);
  auto& from = static_cast<const PNCJunction&>(from_msg);
  ...
  _this->_impl_.passage_group_.MergeFrom(from._impl_.passage_group_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_id()->::apollo::hdmap::Id::MergeFrom(
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_polygon()->::apollo::hdmap::Polygon::MergeFrom(
