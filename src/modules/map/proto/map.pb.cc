...
Projection::Projection(const Projection& from)
  ...
  if (from._internal_has_proj()) {
    _this->_impl_.proj_.Set(from._internal_proj(), 
...
void Projection::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_proj()) {
    _this->_internal_set_proj(from._internal_proj());
  }
...
Header::Header(const Header& from)
  ...
  if (from._internal_has_district()) {
    _this->_impl_.district_.Set(from._internal_district(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_generation()) {
    _this->_impl_.generation_.Set(from._internal_generation(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_rev_major()) {
    _this->_impl_.rev_major_.Set(from._internal_rev_major(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_rev_minor()) {
    _this->_impl_.rev_minor_.Set(from._internal_rev_minor(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_projection()) {
    _this->_impl_.projection_ = new ::apollo::hdmap::Projection(*from._impl_.projection_);
  }
...
void Header::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      _this->_internal_set_rev_major(from._internal_rev_major());
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_internal_set_rev_minor(from._internal_rev_minor());
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_internal_set_vendor(from._internal_vendor());
    }
    if (cached_has_bits & 0x00000080u) {
      _this->_internal_mutable_projection()->::apollo::hdmap::Projection::MergeFrom(
...
Map::Map(const Map& from)
  ...
  if (from._internal_has_header()) {
    _this->_impl_.header_ = new ::apollo::hdmap::Header(*from._impl_.header_);
  }
...
void Map::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.crosswalk_.MergeFrom(from._impl_.crosswalk_);
  _this->_impl_.junction_.MergeFrom(from._impl_.junction_);
  _this->_impl_.lane_.MergeFrom(from._impl_.lane_);
  _this->_impl_.stop_sign_.MergeFrom(from._impl_.stop_sign_);
  _this->_impl_.signal_.MergeFrom(from._impl_.signal_);
  _this->_impl_.yield_.MergeFrom(from._impl_.yield_);
  _this->_impl_.overlap_.MergeFrom(from._impl_.overlap_);
  _this->_impl_.clear_area_.MergeFrom(from._impl_.clear_area_);
  _this->_impl_.speed_bump_.MergeFrom(from._impl_.speed_bump_);
  _this->_impl_.road_.MergeFrom(from._impl_.road_);
  _this->_impl_.parking_space_.MergeFrom(from._impl_.parking_space_);
  _this->_impl_.pnc_junction_.MergeFrom(from._impl_.pnc_junction_);
  _this->_impl_.rsu_.MergeFrom(from._impl_.rsu_);
  if (from._internal_has_header()) {
    _this->_internal_mutable_header()->::apollo::hdmap::Header::MergeFrom(
