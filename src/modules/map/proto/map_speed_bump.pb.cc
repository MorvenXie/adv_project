...
SpeedBump::SpeedBump(const SpeedBump& from)
  ...
  SpeedBump* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void SpeedBump::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<SpeedBump*>(&to_msg);
  auto& from = static_cast<const SpeedBump&>(from_msg);
