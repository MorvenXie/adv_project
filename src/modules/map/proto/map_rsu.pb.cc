...
RSU::RSU(const RSU& from)
  ...
  RSU* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void RSU::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RSU*>(&to_msg);
  auto& from = static_cast<const RSU&>(from_msg);
