...
BoundaryEdge::BoundaryEdge(const BoundaryEdge& from)
  ...
  BoundaryEdge* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void BoundaryEdge::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<BoundaryEdge*>(&to_msg);
  auto& from = static_cast<const BoundaryEdge&>(from_msg);
...
BoundaryPolygon::BoundaryPolygon(const BoundaryPolygon& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  BoundaryPolygon* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void BoundaryPolygon::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<BoundaryPolygon*>(&to_msg);
  auto& from = static_cast<const BoundaryPolygon&>(from_msg);
...
RoadBoundary::RoadBoundary(const RoadBoundary& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RoadBoundary* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_outer_polygon()) {
    _this->_impl_.outer_polygon_ = new ::apollo::hdmap::BoundaryPolygon(*from._impl_.outer_polygon_);
  }
...
void RoadBoundary::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RoadBoundary*>(&to_msg);
  auto& from = static_cast<const RoadBoundary&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:apollo.hdmap.RoadBoundary)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.hole_.MergeFrom(from._impl_.hole_);
  if (from._internal_has_outer_polygon()) {
    _this->_internal_mutable_outer_polygon()->::apollo::hdmap::BoundaryPolygon::MergeFrom(
        from._internal_outer_polygon());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
RoadROIBoundary::RoadROIBoundary(const RoadROIBoundary& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RoadROIBoundary* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void RoadROIBoundary::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RoadROIBoundary*>(&to_msg);
  auto& from = static_cast<const RoadROIBoundary&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:apollo.hdmap.RoadROIBoundary)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.road_boundaries_.MergeFrom(from._impl_.road_boundaries_);
  if (from._internal_has_id()) {
...
RoadSection::RoadSection(const RoadSection& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RoadSection* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_boundary()) {
    _this->_impl_.boundary_ = new ::apollo::hdmap::RoadBoundary(*from._impl_.boundary_);
  }
...
void RoadSection::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RoadSection*>(&to_msg);
  auto& from = static_cast<const RoadSection&>(from_msg);
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_boundary()->::apollo::hdmap::RoadBoundary::MergeFrom(
