...
LaneBoundaryType::LaneBoundaryType(const LaneBoundaryType& from)
  ...
  LaneBoundaryType* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void LaneBoundaryType::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<LaneBoundaryType*>(&to_msg);
  auto& from = static_cast<const LaneBoundaryType&>(from_msg);
...
LaneBoundary::LaneBoundary(const LaneBoundary& from)
  ...
  if (from._internal_has_curve()) {
    _this->_impl_.curve_ = new ::apollo::hdmap::Curve(*from._impl_.curve_);
  }
...
void LaneBoundary::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.boundary_type_.MergeFrom(from._impl_.boundary_type_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_curve()->::apollo::hdmap::Curve::MergeFrom(
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.virtual__ = from._impl_.virtual__;
    }
...
LaneSampleAssociation::LaneSampleAssociation(const LaneSampleAssociation& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  LaneSampleAssociation* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.s_){}
...
void LaneSampleAssociation::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<LaneSampleAssociation*>(&to_msg);
  auto& from = static_cast<const LaneSampleAssociation&>(from_msg);
...
Lane::Lane(const Lane& from)
  ...
  if (from._internal_has_central_curve()) {
    _this->_impl_.central_curve_ = new ::apollo::hdmap::Curve(*from._impl_.central_curve_);
  }
  if (from._internal_has_left_boundary()) {
    _this->_impl_.left_boundary_ = new ::apollo::hdmap::LaneBoundary(*from._impl_.left_boundary_);
  }
  if (from._internal_has_right_boundary()) {
    _this->_impl_.right_boundary_ = new ::apollo::hdmap::LaneBoundary(*from._impl_.right_boundary_);
  }
  if (from._internal_has_junction_id()) {
    _this->_impl_.junction_id_ = new ::apollo::hdmap::Id(*from._impl_.junction_id_);
  }
  ::memcpy(&_impl_.length_, &from._impl_.length_,
...
void Lane::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.predecessor_id_.MergeFrom(from._impl_.predecessor_id_);
  _this->_impl_.successor_id_.MergeFrom(from._impl_.successor_id_);
  _this->_impl_.left_neighbor_forward_lane_id_.MergeFrom(from._impl_.left_neighbor_forward_lane_id_);
  _this->_impl_.right_neighbor_forward_lane_id_.MergeFrom(from._impl_.right_neighbor_forward_lane_id_);
  _this->_impl_.left_neighbor_reverse_lane_id_.MergeFrom(from._impl_.left_neighbor_reverse_lane_id_);
  _this->_impl_.right_neighbor_reverse_lane_id_.MergeFrom(from._impl_.right_neighbor_reverse_lane_id_);
  _this->_impl_.left_sample_.MergeFrom(from._impl_.left_sample_);
  _this->_impl_.right_sample_.MergeFrom(from._impl_.right_sample_);
  _this->_impl_.left_road_sample_.MergeFrom(from._impl_.left_road_sample_);
  _this->_impl_.right_road_sample_.MergeFrom(from._impl_.right_road_sample_);
  _this->_impl_.self_reverse_lane_id_.MergeFrom(from._impl_.self_reverse_lane_id_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_central_curve()->::apollo::hdmap::Curve::MergeFrom(
          from._internal_central_curve());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_left_boundary()->::apollo::hdmap::LaneBoundary::MergeFrom(
          from._internal_left_boundary());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_mutable_right_boundary()->::apollo::hdmap::LaneBoundary::MergeFrom(
          from._internal_right_boundary());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_internal_mutable_junction_id()->::apollo::hdmap::Id::MergeFrom(
          from._internal_junction_id());
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.length_ = from._impl_.length_;
    }
