...
LineSegment::LineSegment(const LineSegment& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  LineSegment* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.point_){from._impl_.point_}
    , /*decltype(_impl_._cached_size_)*/{}};
...
void LineSegment::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<LineSegment*>(&to_msg);
  auto& from = static_cast<const LineSegment&>(from_msg);
...
CurveSegment::CurveSegment(const CurveSegment& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  CurveSegment* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_start_position()) {
    _this->_impl_.start_position_ = new ::apollo::common::PointENU(*from._impl_.start_position_);
  }
  ...
  switch (from.curve_type_case()) {
    case kLineSegment: {
      _this->_internal_mutable_line_segment()->::apollo::hdmap::LineSegment::MergeFrom(
          from._internal_line_segment());
      break;
    }
...
void CurveSegment::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CurveSegment*>(&to_msg);
  auto& from = static_cast<const CurveSegment&>(from_msg);
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_start_position()->::apollo::common::PointENU::MergeFrom(
