...
MonitorMessageItem::MonitorMessageItem(const MonitorMessageItem& from)
  ...
  MonitorMessageItem* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void MonitorMessageItem::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MonitorMessageItem*>(&to_msg);
  auto& from = static_cast<const MonitorMessageItem&>(from_msg);
...
MonitorMessage::MonitorMessage(const MonitorMessage& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MonitorMessage* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void MonitorMessage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MonitorMessage*>(&to_msg);
  auto& from = static_cast<const MonitorMessage&>(from_msg);
