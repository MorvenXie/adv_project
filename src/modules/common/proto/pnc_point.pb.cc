...
SLPoint::SLPoint(const SLPoint& from)
  ...
  SLPoint* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void SLPoint::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
...
FrenetFramePoint::FrenetFramePoint(const FrenetFramePoint& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  FrenetFramePoint* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.s_){}
...
void FrenetFramePoint::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
...
SpeedPoint::SpeedPoint(const SpeedPoint& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  SpeedPoint* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.s_){}
...
void SpeedPoint::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
...
TrajectoryPoint::TrajectoryPoint(const TrajectoryPoint& from)
  ...
  if (from._internal_has_path_point()) {
    _this->_impl_.path_point_ = new ::apollo::common::PathPoint(*from._impl_.path_point_);
  }
  if (from._internal_has_gaussian_info()) {
    _this->_impl_.gaussian_info_ = new ::apollo::common::GaussianInfo(*from._impl_.gaussian_info_);
  }
...
void TrajectoryPoint::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000007fu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_path_point()->::apollo::common::PathPoint::MergeFrom(
          from._internal_path_point());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_gaussian_info()->::apollo::common::GaussianInfo::MergeFrom(
          from._internal_gaussian_info());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.v_ = from._impl_.v_;
    }
...
VehicleMotionPoint::VehicleMotionPoint(const VehicleMotionPoint& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  VehicleMotionPoint* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.trajectory_point_){nullptr}
  ...
  if (from._internal_has_trajectory_point()) {
    _this->_impl_.trajectory_point_ = new ::apollo::common::TrajectoryPoint(*from._impl_.trajectory_point_);
  }
  _this->_impl_.steer_ = from._impl_.steer_;
...
void VehicleMotionPoint::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_trajectory_point()->::apollo::common::TrajectoryPoint::MergeFrom(
...
VehicleMotion::VehicleMotion(const VehicleMotion& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  VehicleMotion* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void VehicleMotion::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.vehicle_motion_point_.MergeFrom(from._impl_.vehicle_motion_point_);
  if (from._internal_has_name()) {
    _this->_internal_set_name(from._internal_name());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
GaussianInfo::GaussianInfo(const GaussianInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  GaussianInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void GaussianInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<GaussianInfo*>(&to_msg);
  auto& from = static_cast<const GaussianInfo&>(from_msg);
  ...
  if (cached_has_bits & 0x0000007fu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_impl_.sigma_x_ = from._impl_.sigma_x_;
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.sigma_y_ = from._impl_.sigma_y_;
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.correlation_ = from._impl_.correlation_;
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.area_probability_ = from._impl_.area_probability_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.ellipse_a_ = from._impl_.ellipse_a_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.ellipse_b_ = from._impl_.ellipse_b_;
    }
    if (cached_has_bits & 0x00000040u) {
