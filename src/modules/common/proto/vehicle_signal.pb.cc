...
VehicleSignal::VehicleSignal(const VehicleSignal& from)
  ...
  VehicleSignal* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void VehicleSignal::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
