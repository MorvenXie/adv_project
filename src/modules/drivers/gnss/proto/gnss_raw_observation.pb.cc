...
BandObservation::BandObservation(const BandObservation& from)
  ...
  BandObservation* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void BandObservation::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<BandObservation*>(&to_msg);
  auto& from = static_cast<const BandObservation&>(from_msg);
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_impl_.frequency_value_ = from._impl_.frequency_value_;
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.band_id_ = from._impl_.band_id_;
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.pseudo_type_ = from._impl_.pseudo_type_;
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.pseudo_range_ = from._impl_.pseudo_range_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.carrier_phase_ = from._impl_.carrier_phase_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.doppler_ = from._impl_.doppler_;
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.loss_lock_index_ = from._impl_.loss_lock_index_;
    }
    if (cached_has_bits & 0x00000080u) {
...
SatelliteObservation::SatelliteObservation(const SatelliteObservation& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  SatelliteObservation* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void SatelliteObservation::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<SatelliteObservation*>(&to_msg);
  auto& from = static_cast<const SatelliteObservation&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:apollo.drivers.gnss.SatelliteObservation)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.band_obs_.MergeFrom(from._impl_.band_obs_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_impl_.sat_prn_ = from._impl_.sat_prn_;
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.band_obs_num_ = from._impl_.band_obs_num_;
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.sat_sys_ = from._impl_.sat_sys_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
EpochObservation::EpochObservation(const EpochObservation& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  EpochObservation* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void EpochObservation::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<EpochObservation*>(&to_msg);
  auto& from = static_cast<const EpochObservation&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:apollo.drivers.gnss.EpochObservation)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.sat_obs_.MergeFrom(from._impl_.sat_obs_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.gnss_week_ = from._impl_.gnss_week_;
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.gnss_second_s_ = from._impl_.gnss_second_s_;
    }
    if (cached_has_bits & 0x00000008u) {
    ...
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.health_flag_ = from._impl_.health_flag_;
    }
    if (cached_has_bits & 0x00000080u) {
      _this->_impl_.sat_obs_num_ = from._impl_.sat_obs_num_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00000100u) {
    _this->_internal_set_gnss_time_type(from._internal_gnss_time_type());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
KepplerOrbit::KepplerOrbit(const KepplerOrbit& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  KepplerOrbit* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.sat_prn_){}
...
void KepplerOrbit::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<KepplerOrbit*>(&to_msg);
  auto& from = static_cast<const KepplerOrbit&>(from_msg);
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.second_s_ = from._impl_.second_s_;
    }
    if (cached_has_bits & 0x00000080u) {
  ...
  if (cached_has_bits & 0x0000ff00u) {
    if (cached_has_bits & 0x00000100u) {
      _this->_impl_.af0_ = from._impl_.af0_;
    }
    if (cached_has_bits & 0x00000200u) {
      _this->_impl_.af1_ = from._impl_.af1_;
    }
    if (cached_has_bits & 0x00000400u) {
      _this->_impl_.af2_ = from._impl_.af2_;
    }
    if (cached_has_bits & 0x00000800u) {
      _this->_impl_.iode_ = from._impl_.iode_;
    }
    if (cached_has_bits & 0x00001000u) {
      _this->_impl_.deltan_ = from._impl_.deltan_;
    }
    if (cached_has_bits & 0x00002000u) {
    ...
    if (cached_has_bits & 0x00008000u) {
      _this->_impl_.roota_ = from._impl_.roota_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00ff0000u) {
    if (cached_has_bits & 0x00010000u) {
      _this->_impl_.toe_ = from._impl_.toe_;
    }
    if (cached_has_bits & 0x00020000u) {
      _this->_impl_.toc_ = from._impl_.toc_;
    }
    if (cached_has_bits & 0x00040000u) {
      _this->_impl_.cic_ = from._impl_.cic_;
    }
    if (cached_has_bits & 0x00080000u) {
      _this->_impl_.week_num_ = from._impl_.week_num_;
    }
    if (cached_has_bits & 0x00100000u) {
      _this->_impl_.l2pdataflag_ = from._impl_.l2pdataflag_;
    }
    if (cached_has_bits & 0x00200000u) {
      _this->_impl_.crc_ = from._impl_.crc_;
    }
    if (cached_has_bits & 0x00400000u) {
      _this->_impl_.cis_ = from._impl_.cis_;
    }
    if (cached_has_bits & 0x00800000u) {
      _this->_impl_.crs_ = from._impl_.crs_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0xff000000u) {
    if (cached_has_bits & 0x01000000u) {
      _this->_impl_.cuc_ = from._impl_.cuc_;
    }
    if (cached_has_bits & 0x02000000u) {
      _this->_impl_.cus_ = from._impl_.cus_;
    }
    if (cached_has_bits & 0x04000000u) {
      _this->_impl_.omega0_ = from._impl_.omega0_;
    }
    if (cached_has_bits & 0x08000000u) {
      _this->_impl_.omega_ = from._impl_.omega_;
    }
    if (cached_has_bits & 0x10000000u) {
      _this->_impl_.i0_ = from._impl_.i0_;
    }
    if (cached_has_bits & 0x20000000u) {
      _this->_impl_.omegadot_ = from._impl_.omegadot_;
    }
    if (cached_has_bits & 0x40000000u) {
      _this->_impl_.idot_ = from._impl_.idot_;
    }
    if (cached_has_bits & 0x80000000u) {
      _this->_impl_.codesonl2channel_ = from._impl_.codesonl2channel_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  ...
  if (cached_has_bits & 0x0000003fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.tgd_ = from._impl_.tgd_;
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.iodc_ = from._impl_.iodc_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.gnss_type_ = from._impl_.gnss_type_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.gnss_time_type_ = from._impl_.gnss_time_type_;
    }
...
GlonassOrbit::GlonassOrbit(const GlonassOrbit& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  GlonassOrbit* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void GlonassOrbit::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<GlonassOrbit*>(&to_msg);
  auto& from = static_cast<const GlonassOrbit&>(from_msg);
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_impl_.slot_prn_ = from._impl_.slot_prn_;
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.year_ = from._impl_.year_;
    }
  ...
  if (cached_has_bits & 0x0000ff00u) {
    if (cached_has_bits & 0x00000100u) {
      _this->_impl_.frequency_no_ = from._impl_.frequency_no_;
    }
    if (cached_has_bits & 0x00000200u) {
      _this->_impl_.week_num_ = from._impl_.week_num_;
    }
    if (cached_has_bits & 0x00000400u) {
      _this->_impl_.week_second_s_ = from._impl_.week_second_s_;
    }
    if (cached_has_bits & 0x00000800u) {
      _this->_impl_.tk_ = from._impl_.tk_;
    }
    if (cached_has_bits & 0x00001000u) {
      _this->_impl_.clock_offset_ = from._impl_.clock_offset_;
    }
    if (cached_has_bits & 0x00002000u) {
      _this->_impl_.clock_drift_ = from._impl_.clock_drift_;
    }
    if (cached_has_bits & 0x00004000u) {
      _this->_impl_.position_x_ = from._impl_.position_x_;
    }
  ...
  if (cached_has_bits & 0x00ff0000u) {
    ...
    if (cached_has_bits & 0x00200000u) {
      _this->_impl_.velocity_z_ = from._impl_.velocity_z_;
    }
    if (cached_has_bits & 0x00400000u) {
      _this->_impl_.accelerate_x_ = from._impl_.accelerate_x_;
    }
    if (cached_has_bits & 0x00800000u) {
      _this->_impl_.accelerate_y_ = from._impl_.accelerate_y_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x0f000000u) {
    if (cached_has_bits & 0x01000000u) {
      _this->_impl_.accelerate_z_ = from._impl_.accelerate_z_;
    }
    if (cached_has_bits & 0x02000000u) {
      _this->_impl_.infor_age_ = from._impl_.infor_age_;
    }
    if (cached_has_bits & 0x04000000u) {
      _this->_impl_.gnss_type_ = from._impl_.gnss_type_;
    }
...
GnssEphemeris::GnssEphemeris(const GnssEphemeris& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  GnssEphemeris* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.keppler_orbit_){nullptr}
  ...
  if (from._internal_has_keppler_orbit()) {
    _this->_impl_.keppler_orbit_ = new ::apollo::drivers::gnss::KepplerOrbit(*from._impl_.keppler_orbit_);
  }
  if (from._internal_has_glonass_orbit()) {
    _this->_impl_.glonass_orbit_ = new ::apollo::drivers::gnss::GlonassOrbit(*from._impl_.glonass_orbit_);
  }
  _this->_impl_.gnss_type_ = from._impl_.gnss_type_;
...
void GnssEphemeris::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<GnssEphemeris*>(&to_msg);
  auto& from = static_cast<const GnssEphemeris&>(from_msg);
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_keppler_orbit()->::apollo::drivers::gnss::KepplerOrbit::MergeFrom(
          from._internal_keppler_orbit());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_glonass_orbit()->::apollo::drivers::gnss::GlonassOrbit::MergeFrom(
          from._internal_glonass_orbit());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.gnss_type_ = from._impl_.gnss_type_;
    }
