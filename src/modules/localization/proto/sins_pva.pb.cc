...
IntegSinsPva::IntegSinsPva(const IntegSinsPva& from)
  ...
  IntegSinsPva* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_position()) {
    _this->_impl_.position_ = new ::apollo::common::PointLLH(*from._impl_.position_);
  }
  if (from._internal_has_velocity()) {
    _this->_impl_.velocity_ = new ::apollo::common::Point3D(*from._impl_.velocity_);
  }
  if (from._internal_has_attitude()) {
    _this->_impl_.attitude_ = new ::apollo::common::Point3D(*from._impl_.attitude_);
  }
  _this->_impl_.init_and_alignment_ = from._impl_.init_and_alignment_;
...
void IntegSinsPva::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<IntegSinsPva*>(&to_msg);
  auto& from = static_cast<const IntegSinsPva&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:apollo.localization.IntegSinsPva)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.pva_covar_.MergeFrom(from._impl_.pva_covar_);
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_position()->::apollo::common::PointLLH::MergeFrom(
    ...
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_mutable_attitude()->::apollo::common::Point3D::MergeFrom(
