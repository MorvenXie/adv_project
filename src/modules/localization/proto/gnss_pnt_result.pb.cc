...
SatDirCosine::SatDirCosine(const SatDirCosine& from)
  ...
  SatDirCosine* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void SatDirCosine::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<SatDirCosine*>(&to_msg);
  auto& from = static_cast<const SatDirCosine&>(from_msg);
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.cosine_x_ = from._impl_.cosine_x_;
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.cosine_y_ = from._impl_.cosine_y_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.cosine_z_ = from._impl_.cosine_z_;
    }
...
GnssPntResult::GnssPntResult(const GnssPntResult& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  GnssPntResult* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void GnssPntResult::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<GnssPntResult*>(&to_msg);
  auto& from = static_cast<const GnssPntResult&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:apollo.localization.GnssPntResult)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.sat_dir_cosine_.MergeFrom(from._impl_.sat_dir_cosine_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.pos_x_m_ = from._impl_.pos_x_m_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.pos_y_m_ = from._impl_.pos_y_m_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.pos_z_m_ = from._impl_.pos_z_m_;
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.std_pos_x_m_ = from._impl_.std_pos_x_m_;
    }
    if (cached_has_bits & 0x00000080u) {
      _this->_impl_.std_pos_y_m_ = from._impl_.std_pos_y_m_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x0000ff00u) {
    if (cached_has_bits & 0x00000100u) {
      _this->_impl_.std_pos_z_m_ = from._impl_.std_pos_z_m_;
    }
    if (cached_has_bits & 0x00000200u) {
      _this->_impl_.pnt_type_ = from._impl_.pnt_type_;
    }
    if (cached_has_bits & 0x00000400u) {
      _this->_impl_.sovled_sat_num_ = from._impl_.sovled_sat_num_;
    }
    if (cached_has_bits & 0x00000800u) {
      _this->_impl_.vel_x_m_ = from._impl_.vel_x_m_;
    }
    if (cached_has_bits & 0x00001000u) {
      _this->_impl_.vel_y_m_ = from._impl_.vel_y_m_;
    }
    if (cached_has_bits & 0x00002000u) {
      _this->_impl_.vel_z_m_ = from._impl_.vel_z_m_;
    }
    if (cached_has_bits & 0x00004000u) {
      _this->_impl_.std_vel_x_m_ = from._impl_.std_vel_x_m_;
    }
    if (cached_has_bits & 0x00008000u) {
      _this->_impl_.std_vel_y_m_ = from._impl_.std_vel_y_m_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x001f0000u) {
    if (cached_has_bits & 0x00010000u) {
      _this->_impl_.std_vel_z_m_ = from._impl_.std_vel_z_m_;
    }
    if (cached_has_bits & 0x00020000u) {
