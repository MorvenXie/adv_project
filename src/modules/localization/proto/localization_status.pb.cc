...
MsfSensorMsgStatus::MsfSensorMsgStatus(const MsfSensorMsgStatus& from)
  ...
  MsfSensorMsgStatus* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void MsfSensorMsgStatus::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
...
MsfStatus::MsfStatus(const MsfStatus& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MsfStatus* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void MsfStatus::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
