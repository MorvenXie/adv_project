...
Config::Config(const Config& from)
  ...
  if (from._internal_has_localization_topic()) {
    _this->_impl_.localization_topic_.Set(from._internal_localization_topic(), 
  ...
  if (from._internal_has_imu_topic()) {
    _this->_impl_.imu_topic_.Set(from._internal_imu_topic(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_gps_topic()) {
    _this->_impl_.gps_topic_.Set(from._internal_gps_topic(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_broadcast_tf_frame_id()) {
    _this->_impl_.broadcast_tf_frame_id_.Set(from._internal_broadcast_tf_frame_id(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_broadcast_tf_child_frame_id()) {
    _this->_impl_.broadcast_tf_child_frame_id_.Set(from._internal_broadcast_tf_child_frame_id(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_localization_status_topic()) {
    _this->_impl_.localization_status_topic_.Set(from._internal_localization_status_topic(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_gps_status_topic()) {
    _this->_impl_.gps_status_topic_.Set(from._internal_gps_status_topic(), 
      _this->GetArenaForAllocation());
  }
...
void Config::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_localization_topic(from._internal_localization_topic());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_imu_topic(from._internal_imu_topic());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_set_gps_topic(from._internal_gps_topic());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_set_broadcast_tf_frame_id(from._internal_broadcast_tf_frame_id());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_internal_set_broadcast_tf_child_frame_id(from._internal_broadcast_tf_child_frame_id());
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_internal_set_localization_status_topic(from._internal_localization_status_topic());
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_internal_set_gps_status_topic(from._internal_gps_status_topic());
    }
    if (cached_has_bits & 0x00000080u) {
      _this->_impl_.gps_imu_time_diff_threshold_ = from._impl_.gps_imu_time_diff_threshold_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00000f00u) {
    if (cached_has_bits & 0x00000100u) {
      _this->_impl_.map_offset_x_ = from._impl_.map_offset_x_;
    }
    if (cached_has_bits & 0x00000200u) {
      _this->_impl_.map_offset_y_ = from._impl_.map_offset_y_;
    }
    if (cached_has_bits & 0x00000400u) {
      _this->_impl_.map_offset_z_ = from._impl_.map_offset_z_;
    }
    if (cached_has_bits & 0x00000800u) {
      _this->_impl_.imu_list_max_size_ = from._impl_.imu_list_max_size_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
