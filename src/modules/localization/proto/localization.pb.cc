...
Uncertainty::Uncertainty(const Uncertainty& from)
  ...
  Uncertainty* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_position_std_dev()) {
    _this->_impl_.position_std_dev_ = new ::apollo::common::Point3D(*from._impl_.position_std_dev_);
  }
  if (from._internal_has_orientation_std_dev()) {
    _this->_impl_.orientation_std_dev_ = new ::apollo::common::Point3D(*from._impl_.orientation_std_dev_);
  }
  if (from._internal_has_linear_velocity_std_dev()) {
    _this->_impl_.linear_velocity_std_dev_ = new ::apollo::common::Point3D(*from._impl_.linear_velocity_std_dev_);
  }
  if (from._internal_has_linear_acceleration_std_dev()) {
    _this->_impl_.linear_acceleration_std_dev_ = new ::apollo::common::Point3D(*from._impl_.linear_acceleration_std_dev_);
  }
  if (from._internal_has_angular_velocity_std_dev()) {
    _this->_impl_.angular_velocity_std_dev_ = new ::apollo::common::Point3D(*from._impl_.angular_velocity_std_dev_);
  }
...
void Uncertainty::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_position_std_dev()->::apollo::common::Point3D::MergeFrom(
          from._internal_position_std_dev());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_orientation_std_dev()->::apollo::common::Point3D::MergeFrom(
          from._internal_orientation_std_dev());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_linear_velocity_std_dev()->::apollo::common::Point3D::MergeFrom(
          from._internal_linear_velocity_std_dev());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_mutable_linear_acceleration_std_dev()->::apollo::common::Point3D::MergeFrom(
          from._internal_linear_acceleration_std_dev());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_internal_mutable_angular_velocity_std_dev()->::apollo::common::Point3D::MergeFrom(
          from._internal_angular_velocity_std_dev());
    }
  }
...
LocalizationEstimate::LocalizationEstimate(const LocalizationEstimate& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  LocalizationEstimate* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_pose()) {
    _this->_impl_.pose_ = new ::apollo::localization::Pose(*from._impl_.pose_);
  }
  if (from._internal_has_uncertainty()) {
    _this->_impl_.uncertainty_ = new ::apollo::localization::Uncertainty(*from._impl_.uncertainty_);
  }
  if (from._internal_has_msf_status()) {
    _this->_impl_.msf_status_ = new ::apollo::localization::MsfStatus(*from._impl_.msf_status_);
  }
  if (from._internal_has_sensor_status()) {
    _this->_impl_.sensor_status_ = new ::apollo::localization::MsfSensorMsgStatus(*from._impl_.sensor_status_);
  }
...
void LocalizationEstimate::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000003fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_pose()->::apollo::localization::Pose::MergeFrom(
          from._internal_pose());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_uncertainty()->::apollo::localization::Uncertainty::MergeFrom(
          from._internal_uncertainty());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_mutable_msf_status()->::apollo::localization::MsfStatus::MergeFrom(
          from._internal_msf_status());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_internal_mutable_sensor_status()->::apollo::localization::MsfSensorMsgStatus::MergeFrom(
          from._internal_sensor_status());
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.measurement_time_ = from._impl_.measurement_time_;
    }
...
LocalizationStatus::LocalizationStatus(const LocalizationStatus& from)
  ...
  if (from._internal_has_state_message()) {
    _this->_impl_.state_message_.Set(from._internal_state_message(), 
