...
LocalizationConfig::LocalizationConfig(const LocalizationConfig& from)
  ...
  LocalizationConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  _this->_impl_.localization_type_ = from._impl_.localization_type_;
...
void LocalizationConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<LocalizationConfig*>(&to_msg);
  auto& from = static_cast<const LocalizationConfig&>(from_msg);
  ...
  if (from._internal_has_localization_type()) {
    _this->_internal_set_localization_type(from._internal_localization_type());
  }
